...
import heroHealthyImg from "@/assets/hero-healthy.jpg";

const HeroSlideCoaching = () => {
  return (
    <div className="absolute inset-0">
      ...
      <div className="absolute inset-0 bg-gradient-to-l from-[#a6ae8b]/90 via-[#a6ae8b]/70 to-[#a6ae8b]/40" />
        ...
        <div className="w-full max-w-2xl mr-0 md:mr-8 lg:mr-16 text-center md:text-right">
          ...
          <div className="flex flex-wrap gap-4 justify-center md:justify-start">
            ...
            <Button
              asChild
              size="lg"
              className="bg-white text-[#a6ae8b] hover:bg-white/90 font-semibold shadow-lg text-lg px-10 py-6"
            >
...
export default HeroSlideCoaching;
